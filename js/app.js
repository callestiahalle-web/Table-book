...
iconPaths.arrow='<path d="M8.5 16h14"/><path d="m17.5 10.5 5.5 5.5-5.5 5.5"/>';
iconPaths.arrowLeft='<path d="M23.5 16h-14"/><path d="m14.5 10.5-5.5 5.5 5.5 5.5"/>';
...
function renderMealDishPicker(){
  ...
  if(slotLabel) slotLabel.textContent=`${slotName} • ${category}`;
  if(back){back.hidden=false; setNavBackButton(back,'К кухням');}
