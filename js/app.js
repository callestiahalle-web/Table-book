...
function homeActionIconHtml(name,label){return `<img class="home-action-icon home-action-icon-light" src="./assets/icons/home-actions/${name}-light.png" alt="${label}" loading="eager" decoding="async"><img class="home-action-icon home-action-icon-dark" src="./assets/icons/home-actions/${name}-dark.png" alt="" loading="eager" decoding="async" aria-hidden="true">`;}
