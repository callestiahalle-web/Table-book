...
function bindPantryFinder(){const input=$('#pantryInput'),add=$('#pantryAdd'); if(add) add.onclick=()=>addPantryTags(input?.value||''); if(input) input.onkeydown=e=>{if(e.key==='Enter'){e.preventDefault();addPantryTags(input.value);}}; renderPantryFinder();}
